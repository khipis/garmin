// ═══════════════════════════════════════════════════════════════════════════
// Pixel.mc — tiny chunky-pixel drawing helpers for ISLAND (module `Px`).
//
// spr()   paints a string-row sprite (one char per cell) via a palette dict,
//         skipping '.'/' ' as transparent, with optional horizontal flip.
// rect()  a flat filled rectangle.
// vgrad() a cheap vertical gradient in `n` bands (used for skies/water).
// Everything is primitive fillRectangle work so it stays crash-free & fast.
// ═══════════════════════════════════════════════════════════════════════════

// ═══════════════════════════════════════════════════════════════
// InputHandler.mc — Swipe-driven controls for Dig Core.
//
// In PLAY:
//   • Swipes set the miner's intended move (queued on the
//     controller and applied at the next tick).
//   • Long drags (≥25 px on the dominant axis) act as swipes —
//     fallback for firmwares that don't expose onSwipe.
//   • Taps during play are intentionally no-ops.
//
// In MENU / RESULT:
//   • UP / PreviousPage   → previous row
//   • DOWN / NextPage     → next row
//   • SELECT              → activate row
//   • Tap on a row        → activate row (hit-test handled by view)
//   • ESC                 → leave the app
// ═══════════════════════════════════════════════════════════════

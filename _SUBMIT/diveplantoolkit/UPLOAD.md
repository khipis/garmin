# Upload Checklist — diveplantoolkit

**Category:** tool  
**App ID (folder):** `diveplantoolkit`
...
- ❌  `diveplantoolkit.iq` — upload this to Connect IQ Developer Portal
- ✅  `diveplantoolkit.prg` — test in Garmin Simulator

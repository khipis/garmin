# Upload Checklist — Arcade Shooter – Space Invaders Watch

**Category:** game  
**App ID (folder):** `arcade`
...
- ❌  `arcade.iq` — upload this to Connect IQ Developer Portal
- ✅  `arcade.prg` — test in Garmin Simulator

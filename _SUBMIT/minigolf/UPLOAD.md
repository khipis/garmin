# Upload Checklist — Mini Golf – Putt Watch Puzzle Game

**Category:** game  
**App ID (folder):** `minigolf`
...
- ❌  `minigolf.iq` — upload this to Connect IQ Developer Portal
- ✅  `minigolf.prg` — test in Garmin Simulator

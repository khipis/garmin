# Upload Checklist — Catapult – Aim & Launch Watch Game

**Category:** game  
**App ID (folder):** `catapult`
...
- ❌  `catapult.iq` — upload this to Connect IQ Developer Portal
- ✅  `catapult.prg` — test in Garmin Simulator

# Upload Checklist — Bricks – Breakout Arcade Watch Game

**Category:** game  
**App ID (folder):** `bricks`
...
- ❌  `bricks.iq` — upload this to Connect IQ Developer Portal
- ✅  `bricks.prg` — test in Garmin Simulator

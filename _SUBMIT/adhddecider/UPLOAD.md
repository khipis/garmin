# Upload Checklist — adhddecider

**Category:** fitness  
**App ID (folder):** `adhddecider`
...
- ❌  `adhddecider.iq` — upload this to Connect IQ Developer Portal
- ❌  `adhddecider.prg` — test in Garmin Simulator

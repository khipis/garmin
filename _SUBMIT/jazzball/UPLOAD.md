# Upload Checklist — JazzBall – Ball Trap Watch Arcade Game

**Category:** game  
**App ID (folder):** `jazzball`
...
- ❌  `jazzball.iq` — upload this to Connect IQ Developer Portal
- ✅  `jazzball.prg` — test in Garmin Simulator

# Upload Checklist — Ski Jump – Distance Watch Sports Game

**Category:** game  
**App ID (folder):** `skijump`
...
- ❌  `skijump.iq` — upload this to Connect IQ Developer Portal
- ✅  `skijump.prg` — test in Garmin Simulator

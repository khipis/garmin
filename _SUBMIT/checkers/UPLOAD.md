# Upload Checklist — Checkers – Classic Board Watch Game

**Category:** game  
**App ID (folder):** `checkers`
...
- ❌  `checkers.iq` — upload this to Connect IQ Developer Portal
- ✅  `checkers.prg` — test in Garmin Simulator

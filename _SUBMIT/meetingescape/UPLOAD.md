# Upload Checklist — meetingescape

**Category:** fitness  
**App ID (folder):** `meetingescape`
...
- ❌  `meetingescape.iq` — upload this to Connect IQ Developer Portal
- ✅  `meetingescape.prg` — test in Garmin Simulator

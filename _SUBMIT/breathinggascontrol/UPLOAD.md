# Upload Checklist — breathinggascontrol

**Category:** tool  
**App ID (folder):** `breathinggascontrol`
...
- ❌  `breathinggascontrol.iq` — upload this to Connect IQ Developer Portal
- ✅  `breathinggascontrol.prg` — test in Garmin Simulator

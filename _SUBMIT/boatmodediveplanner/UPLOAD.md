# Upload Checklist — boatmodediveplanner

**Category:** tool  
**App ID (folder):** `boatmodediveplanner`
...
- ❌  `boatmodediveplanner.iq` — upload this to Connect IQ Developer Portal
- ✅  `boatmodediveplanner.prg` — test in Garmin Simulator

# Upload Checklist — angrypomodoro

**Category:** fitness  
**App ID (folder):** `angrypomodoro`
...
- ❌  `angrypomodoro.iq` — upload this to Connect IQ Developer Portal
- ✅  `angrypomodoro.prg` — test in Garmin Simulator

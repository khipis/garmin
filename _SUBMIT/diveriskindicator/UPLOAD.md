# Upload Checklist — diveriskindicator

**Category:** tool  
**App ID (folder):** `diveriskindicator`
...
- ❌  `diveriskindicator.iq` — upload this to Connect IQ Developer Portal
- ✅  `diveriskindicator.prg` — test in Garmin Simulator

# Upload Checklist — Serpent – Snake Classic Watch Game

**Category:** game  
**App ID (folder):** `serpent`
...
- ❌  `serpent.iq` — upload this to Connect IQ Developer Portal
- ✅  `serpent.prg` — test in Garmin Simulator

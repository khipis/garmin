# Upload Checklist — Parachute – Skydiving Watch Game

**Category:** game  
**App ID (folder):** `parachute`
...
- ❌  `parachute.iq` — upload this to Connect IQ Developer Portal
- ✅  `parachute.prg` — test in Garmin Simulator

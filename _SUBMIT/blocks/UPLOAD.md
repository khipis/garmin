# Upload Checklist — Blocks – Tetris Style Watch Puzzle Game

**Category:** game  
**App ID (folder):** `blocks`
...
- ❌  `blocks.iq` — upload this to Connect IQ Developer Portal
- ✅  `blocks.prg` — test in Garmin Simulator

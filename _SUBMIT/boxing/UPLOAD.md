# Upload Checklist — Boxing Timer – Round Counter Watch

**Category:** fitness  
**App ID (folder):** `boxing`
...
- ❌  `boxing.iq` — upload this to Connect IQ Developer Portal
- ✅  `boxing.prg` — test in Garmin Simulator

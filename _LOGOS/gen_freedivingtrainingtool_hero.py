#!/usr/bin/env python3
"""Generate 1440x720 PREMIUM hero image for Freediving Training Tool (LITE).
...
def gen():
    ...
    title_f = font(58)
    sub_f = font(22)
    title = "FREEDIVING TRAINING TOOL"
    # shadow
    ...
    d.text((W // 2, barY + 74), "Instant freediving training  /  Breathe  /  Apnea  /  CO2  /  O2",
...
if __name__ == "__main__":
    print("Generating freedivingtrainingtool PREMIUM hero image...")
    gen()
    print("Done!")

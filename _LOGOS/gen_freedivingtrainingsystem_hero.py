#!/usr/bin/env python3
"""Generate 1440x720 CINEMATIC hero image for Freediving Training System (PRO).
...
def gen():
    ...
    d.text((ex, ey), "FTS", font=font(20), fill=(255, 255, 255, 255), anchor="mm")
    ...
    f_title = font(68)
    f_sub = font(24)
    title = "FREEDIVING TRAINING SYSTEM"
    ...
    out = os.path.join(OUT, "freedivingtrainingsystem_hero.png")
    final.save(out, "PNG", optimize=True)
    print(f"  -> {out}")


if __name__ == "__main__":
    print("Generating freedivingtrainingsystem CINEMATIC hero image...")
    gen()
    print("Done!")

...
// ═══════════════════════════════════════════════════════════════════════════
//  Input routing for checkers / draughts.
//
...
//      piece slides it along the diagonal in the swipe direction — a diagonal
//      flick IS the checkers move, grab-and-flick in one gesture.
...
// ═══════════════════════════════════════════════════════════════════════════
class BitochiCheckersDelegate extends WatchUi.BehaviorDelegate {
    hidden var _view;

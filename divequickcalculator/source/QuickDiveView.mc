...
// ── Presets ───────────────────────────────────────────────────────────────────
const QDC_FO2_VALS  = [0.21, 0.27, 0.28, 0.29, 0.30, 0.31, 0.32, 0.36];
const QDC_FO2_LBLS  = ["Air 21%", "EAN 27", "EAN 28", "EAN 29", "EAN 30", "EAN 31", "Nitrox 32", "Nitrox 36"];
...
const QC_BG_SAFE    = 0x000000;
const QC_BG_WARN    = 0x000000;
const QC_BG_DANG    = 0x0A0000;
const QC_BG_PULSE   = 0x120000;
const QC_BG_NEUTRAL = 0x000000;

const QC_V_SAFE     = 0x00CC44;
const QC_V_WARN     = 0xFFAA00;
const QC_V_DANG     = 0xFF2222;

const QC_WHITE      = 0xFFFFFF;
const QC_DIM        = 0x333333;
const QC_HINT       = 0x222222;
const QC_CYAN       = 0x0088CC;
const QC_DIVL       = 0x111111;

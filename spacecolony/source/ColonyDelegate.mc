// ═══════════════════════════════════════════════════════════════════════════
// ColonyDelegate.mc — Input for SPACE COLONY.
//
// Buttons and touch both work. SELECT/enter performs the current screen's
// action; UP/DOWN (and swipe up/down) move the row cursor on list screens or
// flip pages elsewhere; swipe left/right flips pages; tap hit-tests rows and
// buttons; BACK saves and exits.
// ═══════════════════════════════════════════════════════════════════════════

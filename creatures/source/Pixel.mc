...
using Toybox.Lang;
module Px {
    // Draw a pixel sprite. rows=Array<String>; each char keys into pal (Dictionary Char->Number color). '.'/' ' = transparent. px = device px per cell. flipX optional.
    ...
    // chunky vertical gradient in n bands (cheap pixel look)

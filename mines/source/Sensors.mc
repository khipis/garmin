// ═══════════════════════════════════════════════════════════════════════════
// Sensors.mc — Garmin sensor hooks for BITOCHI MINES.
//
// Reads real device data where available, degrading to safe neutral values
// everywhere else. Steps power mining expeditions (bonus depth, hidden tunnels,
// rare resource chance), workouts add a mining-power boost, sleep gives a
// night-mining efficiency bonus, heart rate feeds an activity bonus. Every
// accessor is fully guarded so a missing capability can never throw — it just
// returns 0.
// ═══════════════════════════════════════════════════════════════════════════
...
module Sensors {
    ...
    // Steps recorded so far today. Powers mining expeditions & discovery.
    ...
    // Grants a night-mining efficiency bonus on return.
    ...
    // Active/intensity minutes today. Adds a mining-power boost.

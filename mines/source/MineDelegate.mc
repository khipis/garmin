// ═══════════════════════════════════════════════════════════════════════════
// MineDelegate.mc — Input for BITOCHI MINES.
//
// Buttons and touch both work. SELECT/enter performs the current screen's
// action (dig, upgrade, claim); UP/DOWN (and swipe up/down) move the cursor on
// list/grid screens or flip pages elsewhere; swipe left/right flips pages; tap
// hit-tests rows, grid cells and buttons; BACK saves and exits.
// ═══════════════════════════════════════════════════════════════════════════
